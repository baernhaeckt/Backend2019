...
namespace Backend.Core.Features.Quiz
{
    public static class Logging
    {
        ...
        public static void ExecuteAnswerQuizQuestionSuccessful(this ILogger logger, Guid userId, Guid questionId, bool isCorrect, Guid answerId)
        {
            logger.LogInformation(new EventId(4, typeof(Logging).Namespace), "Executed answer quiz question. UserId: {userId}, QuestionId: {questionId}, IsCorrect: {isCorrect}, AnswerId: {answerId}", userId, questionId, isCorrect, answerId);
        }
    }
}